...
var SoloMenu = function () {
    ...
    var getGames = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.post("/api/getSoloGames/" + id, { num: index }, lib_1.headers)];
                case 1:
                    res = (_a.sent()).data;
                    setGames(games.length === 0 ? res : __spreadArray(__spreadArray([], games), res));
                    setIndex(index + 5);
                    return [2 /*return*/];
            }
        });
    ...
    return (<div className='friendMenu'>
      ...
      {selected ?
          ...
          <div className='small'>
            <Word_1.default arr={[]} guess={selected.guesses} word={selected.word.split('')}/>
          </div>
          <button className='button' onClick={function () { return setSelected(null); }}>Back...</button>
            ...
            <div className='small'>
              <Word_1.default arr={[]} guess={g.guesses} word={g.word.split('')}/>
            </div>
