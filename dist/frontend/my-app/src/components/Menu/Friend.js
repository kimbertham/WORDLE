...
var FriendMenu = function (_a) {
    ...
    var getGames = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.post("/api/getFriendGames/" + _id, { skip: index, limit: 5 }, lib_1.headers)];
                case 1:
                    res = (_a.sent()).data;
                    if (res.length < 5)
                        setHide(true);
    ...
    return (<div className='friendMenu'>
      ...
      {selected &&
          ...
          <div className='showPastCont'>
            {selected.players.map(function (p) {
                ...
                <h1>{lib_1.cap(p.user.username)}</h1>
      ...
      {!selected && games.length > 0 &&
        ...
        {games.map(function (g) {
            ...
            <div>
              <p>{lib_1.cap(g.players[1].word)}</p>
