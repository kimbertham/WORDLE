...
var Friend = function (_a) {
    ...
    var _b = react_1.useState(true), request = _b[0], setRequest = _b[1];
    var _c = react_1.useState(false), result = _c[0], setResult = _c[1];
    var _d = react_1.useState(), currentRound = _d[0], setCurrentRound = _d[1];
    ...
    var getLastRound = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.post("/api/getFriendGames/" + id, { skip: 0, limit: 1 }, lib_1.headers)];
                case 1:
                    res = (_a.sent()).data[0];
                    if (res) {
                        setCurrentRound(res);
