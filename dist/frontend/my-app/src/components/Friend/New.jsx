...
var NewGame = function () {
    var _a = (0, react_1.useState)([]), arr = _a[0], setArr = _a[1];
    var _b = (0, react_1.useState)([]), opp = _b[0], setOpp = _b[1];
    var _c = (0, react_router_dom_1.useParams)(), friend = _c.friend, game = _c.game;
    ...
    var getFriendship = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("/api/getFriendship/".concat(friend), lib_1.headers)];
                case 1:
                    res = _a.sent();
                    opponent = res.data.users.filter(function (u) { return u._id !== (0, lib_1.userId)(); })[0];
                    setOpp(opponent);
                    return [2 /*return*/];
            }
        });
    ...
    var newGame = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    history.push("/friend/".concat(friend));
                    return [2 /*return*/];
            }
        });
    }); };
    var acceptReq = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.post("/api/acceptRequest/".concat(game), { user: opp, word: arr.join('') }, lib_1.headers)];
                case 1:
                    _a.sent();
                    history.push("/friend/".concat(friend));
                    return [2 /*return*/];
    ...
    return (<div className='bm'>
      ...
      <div className='top'>
        <div className='flex fw'>
          {__spreadArray([], Array(5), true).map(function (l, i) {
        ...
        switch (_b.label) {
            case 0:
                _a = setArr;
                return [4 /*yield*/, (0, lib_1.getRandom)()];
