...
exports.cap = exports.getDef = exports.getRandom = exports.checkWord = exports.wordHeaders = exports.userId = exports.headers = void 0;
var axios_1 = __importDefault(require("axios"));
exports.headers = { headers: { Authorization: "Bearer ".concat(window.localStorage.getItem('token')) } };
var userId = function () {
    var _a;
    var token = (_a = window.localStorage.getItem('token')) === null || _a === void 0 ? void 0 : _a.split('.');
    if (token)
        return JSON.parse(window.atob(token[1])).sub;
};
...
var getDef = function (word) { return __awaiter(void 0, void 0, void 0, function () {
    var res, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
